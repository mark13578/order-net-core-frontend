export default {
  ...
  errorLog: {
    tips: '請點擊右上角bug小圖標',
    description: '現在的管理後台基本都是spa的形式了，它增強了用户體驗，但同時也會增加頁面出問題的可能性，可能一個小小的疏忽就導致整個頁面的死鎖。好在 Vue 官網提供了一個方法來捕獲處理異常，你可以在其中進行錯誤處理或者異常上報。',
    documentation: '文檔介紹'
  },
  excel: {
    export: '導出',
  ...
  operation: {
    result: {
      successTitle: '成功',
      addSuccessTitle: '創建成功',
      editSuccessTitle: '更新成功',
      deleteSuccessTitle: '刪除成功',
      updateStatusSuccessTitle: '狀態更新成功',
      failedTitle: '失敗'
    },
